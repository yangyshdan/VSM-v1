...
public class JavaMail {  
    ...
    public static void main(String[] args) {
		...
		se.initProps("smtp.qq.com", "25");
		String head = "[邮件]TPC监控：[196.1.1.97,SR存储设备资源管理系统]告警信息摘要";
		String msg = "qwerrttt<br/>123444433<span style='color:red'>测试邮件颜色</span>";
		se.doSendHtmlEmail("smtp.qq.com", "648143473@qq.com", "gugu_7747", head, msg, "648143473@qq.com");
	}
}  
