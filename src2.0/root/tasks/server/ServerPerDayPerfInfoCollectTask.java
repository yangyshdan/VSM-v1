 ...
 *
 */
public class ServerPerDayPerfInfoCollectTask implements Task {
	
	private Logger logger = Logger.getLogger(ServerPerDayPerfInfoCollectTask.class);
...
//	private PrfTimestampService timestampService = new PrfTimestampService();
	...
	public void execute() {
		try {
			logger.info("<===================== BEGIN ServerPerDayPerfInfoCollectTask ======================>");
...
//			onCollectPerDayPerfInfo(physicalList);
//			List<DataRow> virtualList = agentService.getVirtualConfigList();
//			onCollectPerDayPerfInfo(virtualList);
			
			//采集X86服务器性能信息  已修复既可以统计Linux和Window
			obj.generatePrfDaily();
			logger.info("<===================== END ServerPerDayPerfInfoCollectTask ======================>");
		} catch (Exception e) {
	 ...
	 * @param computerList
//	 */
//	public void onCollectPerDayPerfInfo(List<DataRow> computerList) {
//		try {
...
//						logger.info("It's success to collect per day server performance info !");
//					}
//				}
//			}
//		} catch (Exception e) {
