package com.huiming.service.sr.initial;
...
public class InitializeService extends BaseService{
	...
	public boolean isExsistSystem(String model){
		boolean isFlag = false;
		StorageSystemService service = new StorageSystemService();
		List<DataRow> rows = service.getStorageCapacityInfo(null);
		for (DataRow dataRow : rows) {
			if(model.equalsIgnoreCase(dataRow.getString("model"))){
				isFlag =  true;
				break;
			}
		}
