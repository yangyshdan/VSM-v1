package com.huiming.service.sr.ddm;
...
public class DdmService extends BaseService {
	...
	public void updateDDMInfo(List<DataRow> ddms,Integer subSystemID){
		for (DataRow dataRow : ddms) {
			...
			String sql = "select name from t_res_storage_ddm where name = '"+dataRow.getString("name")+"' and subsystem_id = "+subSystemID;
	...
	public DBPage getDiskPage(int curPage,int numPerPage,Integer subsystemId,Integer diskgroupId){
		String sql="SELECT d.* FROM t_res_storage_ddm d,t_map_diskgroup2storage_ddm m " +
				"WHERE d.DDM_ID = m.DDM_ID ";
		StringBuffer sb = new StringBuffer(sql);
		List<Object> args = new ArrayList<Object>();
	...
	@SuppressWarnings("unchecked")
	public List<DataRow> getDiskList(Integer subsystemId,Integer diskgroupId){
		String sql="SELECT d.* FROM t_res_storage_ddm d,t_map_diskgroup2storage_ddm m " +
		"WHERE d.DDM_ID = m.DDM_ID ";
		StringBuffer sb = new StringBuffer(sql);
		List<Object> args = new ArrayList<Object>();
