...
<div id="content">
	...
	<div id="homeContent" class="tab-content" style="overflow: visible;min-height:200px;">
		...
		<div class="row-fluid sortable" style="margin-top: 10px;" id="logContent" >
			<a id="Physical" href="${path}/servlet/hypervisor/HypervisorAction?func=HypervisorPage" class="well span3 top-block" style="color: black;">
				<img class="assetsImg"  alt="hypervisor" src="${path}/resource/img/project/hv.png">
				<span id="hvAssets" class="notification">物理机</span>
			</a>
			<a id="Virtual" href="${path}/servlet/virtual/VirtualAction?func=VirtualPage" class="well span3 top-block" style="color: black;">
				<img class="assetsImg"  alt="virtual" src="${path}/resource/img/project/host.png">
				<span id="vmAssets" class="notification">虚拟机</span>
			</a>		 
			<a id="Storage" href="${path}/servlet/storage/StorageAction?func=StoragePage" class="well span3 top-block" style="color: black;">
			...
			<a id="Switch" href="${path}/servlet/switchs/SwitchAction?func=SwitchPage" class="well span3 top-block" style="color: black;">
