	...
	<div class="row-fluid">
		<div class="box span12">
			...
			<div class="box-content">
				...
				<div class="tab-pane active" id="nodeContent" style="overflow: visible;">
					...
					<c:if test="${not empty nodePage.data}">
						<script>
							...
							$("#nodeListpageNub").getLinkStr({pagecount:"${nodePage.totalPages}",curpage:"${nodePage.currentPage}",numPerPage:"${nodePage.numPerPage}",isShowJump:true,ajaxRequestPath:"${path}/servlet/node/NodeAction?func=AjaxNodePage&"+param,divId:'nodeContent'});
						</script>
					</c:if>
