...
function defaultStorage(){
	...
	for(var i in jsonList){
		...
		for(var j = 0; j < dev.length; j++){
			...
			else if(jsonList[i].id == switchId){
				str += "selected=selected";
			}
		}
...
function saveInfoHgc(){
	...
	$.ajax({
		url:"${pageContext.request.contextPath}/servlet/switchs/SwitchAction?func=SwitchPrf2",
		data: jsonVal,
							...
							<tr id="devtypeAndDevice">
								...
								<td id="storageTypeTd">
									...
									<div class="input-prepend input-append">
										<select class="form-control" name="storageType" disabled="disabled" id="storageType" style="width:180px;"> 
											<option selected="selected"" value="SWITCH">交换机</option>
										</select>
										<input type="hidden" name="storageType" value="SWITCH">
									</div>
								...
								<td id="deviceTd">
									...
									<div class="input-prepend input-append">
										...
										<input type="hidden" name="devId" value="${switchId}" />
									</div>
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
