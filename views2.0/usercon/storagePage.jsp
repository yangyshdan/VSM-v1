			...
			<c:forEach var="item" items="${storagePage.data}" varStatus="status">
				<tr>
					...
					<td>
						...
						<td>
							<a class="btn btn-success" data-rel='tooltip' href="javascript:MM_openwin3('添加','${path}/servlet/usercon/UserConAction?func=EditDeviceInfo&id=${item.id}&typeId=1',500,400,0)" title="edit"><i class="icon-zoom-in icon-white"></i>编辑</a>
