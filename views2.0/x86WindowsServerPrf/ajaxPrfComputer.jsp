...
<div class="tab-pane" id="dataContent2">
	...
	<c:if test="${not empty prfData}">
		...
		$("#ComputerInfopageNub").getLinkStr({pagecount:"${prfData.tbody.totalPages}",curpage:"${prfData.tbody.currentPage}",
		numPerPage:"${prfData.tbody.numPerPage}",isShowJump:true,
