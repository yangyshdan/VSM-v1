		...
		<form class="form-horizontal" id="conditionForm">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-prepend input-append">
							<select class="form-control" name="storageType" id="storageType" style="width: 180px;" disabled="disabled">
								<option value="">Windows X86 服务器</option>
							</select>
						</div>
					</div>
					<input type="hidden" name="storageType" value="X86" />
				...
				<div class="control-group">
					...
					<input type="hidden" name="devId" value="${computerId}" />
				</div>
	...
	function() {
		...
		$("button[type='reset']").click(function(){
			...
			if(levels!=3){
				...
				$("#prfField option:selected").removeAttr("selected");
...
function saveInfo(){
	...
	$.ajax({
		url:"${path}/servlet/x86WindowsPrf/X86WindowsServerPrfAction?func=ComputerPrf",
		data: jsonVal,
		success:function(result){
			if(result == "true"){
				<c:choose>
					<c:when test="${not empty isListDraw and isListDraw}">
