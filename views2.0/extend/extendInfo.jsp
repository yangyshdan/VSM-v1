...
<script type="text/javascript">
	...
	<%--$(function(){
		增加查询条件
		$.ajax({
			url: "${path}/servlet/extend/ExtendAction?func=ExtendSettingPrf2",
			data: {subSystemID: "${subSystemID}", level: 3, extendId: "${extendInfo.storage_extent_id}" },
			type: "post",
			dataType: "html",
...
<ul class="nav nav-tabs" id="myTab">
		...
		<%--<li class=""><a href="#prfTab">性能</a></li>--%>
		<li class="">
	...
	<div class="row-fluid">
		<div class="box span12">
			...
			<div class="box-content" style="min-height:300px;">
				<!-- tab切换标签开始 -->
				<ul class="nav nav-tabs" id="myTab">
					<li class="active"><a href="#loadcontent">性能曲线</a></li>
					<li class=""><a href="#dataContent">性能数据</a></li>
				</ul>
				<!-- tab切换标签结束 -->
	...
	<div class="row-fluid">
		<div class="box span12">
			...
			<div class="box-content" id="dAlertContent">
				...
				<div class="pagination pagination-centered" id="alertListNub"></div>
				<c:if test="${(not empty deviceLogPage) and (not empty deviceLogPage.data)}">
					<script>
						$("#alertListNub").getLinkStr({
							...
							isShowJump:true,
							ajaxRequestPath:"${path}/servlet/alert/DeviceAlertAction?func=AjaxPage&topId=${subSystemID}&resourceId=${extendInfo.storage_extent_id}&resourceType=Storage",
							divId: "dAlertContent"
						});
					</script>
				</c:if>
