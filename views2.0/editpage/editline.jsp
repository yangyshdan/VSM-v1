...
<div class="box span6" id="charts_new">
	...
	<div class="box-header well">
		<h2><i class="icon-plus-sign"></i> ${empty item.fid ? '新增' : '编辑'}曲线图模块</h2>
		<div class="box-icon">
...
$(function(){
	...
	if (moduleInfo != null) {
		...
		$("#flegend").val(moduleInfo.flegend);
		if (moduleInfo.flegend == 0) {
			$("#flegend div").first().removeClass("switch-on");
			$("#flegend div").first().addClass("switch-off");
		}
