...
<script src="${path}/resource/js/project/report.js"></script>
...
$(function(){
	...
	if(editTask!=null){
		$("#report-title").html("编辑任务报表");
		$("input[name='report_type'][value='0']").removeAttr("checked");
		$("input[name='report_type'][value='0']").parent().hide();
		$("input[name='report_type'][value='0']").parent().next("div").hide();
		$("input[name='report_type'][value='1']").attr("checked","checked");
		$.each($("#exeType1 option"),function(i){
			if($(this).val()==editTask.exe_type1){
	...
	BaseForm.ckeckTime();
	//配置信息部分
	$("#c_storage_type").multiselect({maxHeight : 150});
	$("#c_storage_type").multiselect("rebuild");
	...
	//性能信息部分
	$("#p_storage_type").multiselect({maxHeight : 150});
	$("#p_storage_type").multiselect("rebuild");
	...
	//TopN信息部分
	$("#t_storage_type").multiselect({maxHeight : 150});
	$("#t_storage_type").multiselect("rebuild");
	...
	$("#exeType1").multiselect({
		maxHeight : 175
	});
	$("#exeType2").multiselect({
		maxHeight : 175
	});
	$("#exeType3").multiselect({
		maxHeight : 175
	});
												  ...
												  <fieldset>
													<legend>配置</legend>
														...
														<div class="control-group">
															...
															<div class="controls">
																<label class="radio">
																	<input type="radio" name="report_type" value="0" checked="checked">
																	即时报表   (保存设置后立即产生报表)
																</label>
														...
														<div class="control-group" id="reportNameDiv">
						                  		...
						                  		<form class="b" id="timelyReport">
						                  			<table class="table-condensed">
						                  				...
						                  				<tr>
						                  					...
						                  					<td>
						                  						<input value="${historyConfig.starttime}"  class="readonly" name="startTime" id="startTime" type="text" style="cursor:pointer;" onClick="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" readonly="readonly"/>
															</td>
						                  					<td style="padding-bottom:10px;" align="right">
						                  						结束时间&nbsp;&nbsp;
						                  					</td>
						                  					<td>
																<input value="${historyConfig.endtime}" name="endTime" id="endTime" type="text" style="cursor:pointer;" onClick="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" readonly="readonly"/>
						                  					</td>
						                  				</tr>
						                  			</table>
												</form>
												</div>
												<div id="taskTab" style="display: none;">
												<div class="t">任务报表</div>
												<form class="b" id="taskReport">
													<table class="table-condensed">
						                  				<tr>
						                  					<td style="padding-bottom:10px;width:140px;" align="right">
						                  						执行方式&nbsp;&nbsp;
						                  					...
						                  					<td>
						                  						<select id="exeType1" name="exeType1" onchange="BaseForm.checkExetype()">
						                  					...
						                  					<td>
						                  						<select id="exeType2" name="exeType2">
						                  							
																</select>
						                  					</td>
						                  					<td>
						                  						<select id="exeType3" name="exeType3">
												...
												<form class="form-horizontal" style="margin:0px;" id="aForm">
												  <fieldset>
													...
													<div class='form-actions' style="width:100%;margin-top:100px;padding-left:0px;" align="center">
														<a href="javascript:Report.review()" type="button" class="btn btn-success" >内容预览</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<a href="javascript:Report.execReport()" type="button" class="btn btn-primary">应&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用</a>
													</div>
												</form>  
