...
$(function(){
	<%--增加查询条件--%>
	$.ajax({
		url: "${path}/servlet/arraysite/ArraysiteAction?func=ArraysiteSettingPrf2",
		data: {subSystemID: "${subSystemID}", level: 3, arraysiteId: "${arraysiteInfo.disk_group_id}" },
		type: "post",
		dataType: "html",
			...
			<table class="table configTable" style="margin-bottom:0px;width:49%;float:left;">   
			  <tbody>
				...
				<%--<tr>
					<th><h4>控制器工作状态</h4></th>
					<td class="center">
						${resarrayInfo.controller_status}
					</td>                                       
				</tr>
				<tr>
					<th><h4>电池工作状态</h4></th>
					<td class="center">
						${resarrayInfo.battery_status}
					</td>                                       
				</tr>
		 ...
		 <table class="table configTable" style="margin-bottom:0px;width:49%;float:left;">   
			  <tbody>
				...
				<%--<tr>
					<th><h4>接口卡工作状态</h4></th>
					<td class="center">
						${resarrayInfo.hea_status}
					</td>                                       
				</tr>
				<tr>
					<th><h4>盘柜状态</h4></th>
					<td class="center">
						${resarrayInfo.disk_enclosure_status}
					</td>                                       
				</tr>
				<tr>
					<th><h4>光纤模块状态</h4></th>
					<td class="center">
						${resarrayInfo.fiber_status}
					</td>                                       
				</tr>
				<tr>
					<th><h4>磁盘工作状态</h4></th>
					<td class="center">
						${resarrayInfo.disk_status}
					</td>                                       
				</tr>
			  --%></tbody>
		 </table>  
						...
						<c:if test="${isTbodyNotEmpty}">
							<script>
								$("#arraysiteInfopageNub").getLinkStr({
									...
									isShowJump:true,
									ajaxRequestPath:"${path}/servlet/arraysite/ArraysiteAction?func=ArraysitePrfPage&arraysiteId=${arraysiteInfo.disk_group_id}&level=3&tablePage=1&subSystemID=${subSystemID}",
									divId:'dataContent'});
	...
	<div class="row-fluid">
		<div class="box span12">
			...
			<div class="box-content">
				<div class="tab-pane active" id="diskContent">
