...
<div class="tab-pane" id="dataContent2" style="padding-top:10px;">
	...
	<c:if test="${not empty prfData.tbody.data}">
		<script>
			$("#virtualInfopageNub").getLinkStr({pagecount:"${prfData.tbody.totalPages}",curpage:"${prfData.tbody.currentPage}",numPerPage:"${prfData.tbody.numPerPage}",
			isShowJump:true,ajaxRequestPath:"${path}/servlet/virtual/VirtualAction?func=VirtualPrfPage&hypervisorId=${hypervisorId}&vmId=${vmId}&level=3&tablePage=1",divId:'dataContent2'});
			$("#exportCSV").unbind();
