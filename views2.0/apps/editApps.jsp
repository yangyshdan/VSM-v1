			...
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<input type="hidden" name="devId" value="${fappId}" />
						<input type="hidden" name="fappId" value="${fappId}">
						<input type="hidden" name="storageType" value="APPLICATION" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-prepend input-append">
							<select id="device" multiple="multiple" name="device" class="form-control">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-prepend input-append">
							<select id="prfField" multiple="multiple" name="prfField" class="form-control">
				...
				<div class="control-group">
					<label class="control-label" for="yaxisname">
						y轴名称
					</label>
					<div class="controls">
						<div class="input-prepend input-append">
							<input value="${historyConfig.fyaxisname}" name="yname" id="yname" style="width: 180px;" type="text">
						</div>
					</div>
				</div>
					...
					<div class="controls">
						<div class="input-prepend input-append">
							<c:choose>
								...
								<c:otherwise>
									<input name="isshow" checked="checked" id="isshow" data-no-uniform="true" value="1" type="checkbox" class="iphone-toggle">
								</c:otherwise>
							</c:choose>
						</div>
						<input id="hideisshow" type="hidden" name="hideisshow" value=""/>
					</div>
...
function saveInfo(){
	...
	$.ajax({
		url:"${path}/servlet/apps/AppsAction?func=AppsPrf",
		data:jsonVal,
