						                  		...
						                  		<form class="b" id="timelyReport">
						                  			<table class="table-condensed">
						                  				...
						                  				<tr>
						                  					...
						                  					<td>
						                  						<input value="" class="readonly" name="startTime" id="startTime" type="text" style="cursor:pointer;" onClick="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" readonly="readonly"/>
															</td>
						                  					<td style="padding-bottom:10px;" align="right">
						                  						结束时间&nbsp;&nbsp;
						                  					</td>
						                  					<td>
																<input value="" name="endTime" id="endTime" type="text" style="cursor:pointer;" onClick="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" readonly="readonly"/>
						                  					</td>
						                  				</tr>
						                  			</table>
												</form>
