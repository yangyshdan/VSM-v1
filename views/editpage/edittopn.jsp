...
<div class="box span6" id="charts_new">
	...
	<div class="box-header well">
		<h2><i class="icon-plus-sign"></i> 新增TopN图</h2>
		<div class="box-icon">
				...
				<div id="prfContent-c" style="width: 95%; height: 100px;line-height:30px;">
					<table style="width: 100%;margin-top:10px;" class="form">
						<tr>
							<td>设备类型</td>
							<td>
								<select class="form-control" id="devType" onchange="Widget.changeTopnDevType()">
						...
						<tr>
							<td>类型</td>
							<td>
								<select id="subDev" onchange="Widget.changeTopnsub()">
