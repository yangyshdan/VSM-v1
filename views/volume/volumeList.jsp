...
function doFreshen(){
	var jsonVal={name:$("#hiddenName").val(),lessLogical_Capacity:$("#hiddenLessLogical_Capacity").val(),greatLogical_Capacity:$("#hiddenGreatLogical_Capacity").val(),subSystemID:subsystemId};
	loadData("${path}/servlet/volume/VolumeAction?func=AjaxVolumePage",jsonVal,$("#volumeContent"));
}
//清除
function clearData(){
...
function doListRefresh(){
	loadData("${path}/servlet/volume/VolumeAction?func=VolumePrfField",{isFreshen:1,subSystemID:subsystemId},$("#prfContent"),false,false,false,true,
		function(data){
			var json = eval("("+data+")");
	...
	<div class="row-fluid">
		<div class="box span12">
			...
			<div class="box-content">
				...
				<div class="tab-pane active" id="volumeContent" style="text-align: center;overflow-y: hidden;">
