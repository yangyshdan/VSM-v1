									...
									<tr style="cursor:pointer;" ondblclick="DeviceAlert.doDetailInfo('${item.fruleid}','${item.ftopid}','Fabric')">
										<td>
											<label class="checkbox inline">
												...
												<td>
												<a href="javascript:DeviceAlert.doDetailInfo('${item.fruleid}','${item.ftopid}','Fabric')" data-placement="left"  data-rel="popover" data-content="Device Type:${item.fresourcetype}<br/>Device Name:${item.fresourcename } <br/><c:choose><c:when test="${fn:length(item.fdetail) > 200}">
	 ...
	 -->
			...
			<div class="box-content" style="max-height:810px;" id="subTab">
				<ul class="nav nav-tabs" id="myTab">
					...
					<li title="zset">
						<a href="#zsetContent">区域集(${zsetCount})</a>
					</li>
				</ul>
				<div id="perfChart" class="tab-content" style="overflow: visible;min-height:200px;">
				<!-- 交换机开始 -->
					<div class="tab-pane active" id="switchContent" style="padding-top:10px;overflow-y: hidden;">
					...
					<!-- 交换机结束 -->
					<!-- 区域集开始 -->
					<div class="tab-pane" id="zsetContent" style="padding-top:10px;overflow-y: hidden;">
